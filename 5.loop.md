...
~~~
python $hicpro2fithic -i Input_matrix使用HiC-b $Hic_ann/${Res}_mm10.bed -s $Input_bias 
...
~~~
nohup hicConvertFormat -m Input_matrix --inputFormat hicpro --bedFileHicpro $Hic_ann/${Res}_mm10.bed 
