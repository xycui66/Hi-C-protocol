...
#qvalue 0.01
for i in {1..19} X;do chr=chr${i}; 
zcat 02.fithic_res/SAMPLE_${res}_${chr}.spline_pass2.res${res}.significances.txt.gz|
awk '$7<0.01 {print $1,$2-5000,$2+5000,$3,$4-5000,$4+5000,$5,$10,$7}'
> 03.significant_bin/SAMPLE_${res}_${chr}_qvalueCutOff.bedpe & 
done
cat 03.significant_bin/*bedpe > 03.significant_bin/SAMPLE_${res}_qvalueCutOff.bedpe
~~~
...
~~~
#### Step1 hicpro2cool
hicConvertFormat属于[hicexplorer tools](https://hicexplorer.readthedocs.io/en/latest/content/list-of-tools.html) 此工具类似deeptools，功能很多，建议尝试。
~~~
