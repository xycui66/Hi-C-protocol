...
bash $hicpro2juicebox -i HicPro_Output/hic_results/data/SAMPLE/SAMPLE.allValidPairs 
-g $HiCPro_anno/chrom_mm10.sizes -j $JUICERJAR 
-r $HiCPro_anno/mm10_MboI.bed -t Juicebox_OutDir

java -jar $JUICERJAR pre -r 10000,20000,40000,50000,75000,100000,300000,500000,1000000,4000000 
-f Juicebox_OutDir/*resfrag.juicebox Juicebox_OutDir/*.pre_juicebox_sorted Juicebox_OutDir/SAMPLE.hic 
$HiCPro_anno/chrom_mm10.sizes
~~~
