...
rawfastqDir=/home2/xycui/Hic_Protocal/0.0rawdata/ \
Data informations:young(2-month) female mouse
...
```
cutadapt -j 40 -a adapter -A adapter --trim-n -m 50 -q 20,20 -o 0.1cleandata/SAMPLE.R1.fastq.gz -p 0.1cleandata/SAMPLE.R2.fastq.gz 
0.0rawdata/SAMPLE.R1.fastq.gz 0.0rawdata/SAMPLE.R2.fastq.gz > 0.1cleandata/logs/SAMPLE.cutadapt.log
```
#### Cleandata fastqc
```
fastqc 0.1cleandata/SAMPLE.R*.fastq.gz -o 0.1cleandata_QC/ >> 0.1cleandata_QC/qc.log
```
...
### Run HiC-Pro
~~~
HiCProV3=/usr/local/software/HiC-Pro-3.1.0/bin/HiC-Pro
$HiCProV3 -i Input_Dir/ -o Output_Dir -c config-hicpro.txt
~~~
### Results
~~~
    + bowtie_results/
